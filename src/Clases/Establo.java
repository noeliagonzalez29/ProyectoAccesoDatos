...
public class Establo implements Serializable {
    ...
    /**
     * Metodo que llama a otro metodo en la clase BasesDatos para resetear los datos al iniciar nueva partida
     */
    ...
    /**
     * Metodo que llama a otro metodo en la clase BasesDatos para restablecer la conexion cuando cargamos una partida
     */
    public void resstablecerConexionE() {
        basesDatos.restablecerConexion();
    }
}
